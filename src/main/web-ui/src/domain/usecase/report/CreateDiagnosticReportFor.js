...
exports.useCreateDiagnosticReportFor = void 0;
var react_1 = require("react");
var ReportDao_1 = require("../../../data/api/dao/ReportDao");
//HTTP 403, 400, 409, 201
var useCreateDiagnosticReportFor = function () {
    ...
    var createDiagnosticReportFor = function (createDiagnosticReportRequest) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setState(__assign(__assign({}, state), { isLoading: true }));
                    return [4 /*yield*/, ReportDao_1.default.createDiagnosticReportFor(createDiagnosticReportRequest)
                            .then(function (res) {
                            console.log(res);
                            setState({
