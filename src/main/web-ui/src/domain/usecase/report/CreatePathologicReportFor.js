...
var useCreatePathologicReportFor = function () {
    ...
    var createPathologicReportFor = function (createPathologicReportRequest) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setState(__assign(__assign({}, state), { isLoading: true }));
                    return [4 /*yield*/, ReportDao_1.default.createPathologicReportFor(createPathologicReportRequest)
                            .then(function (res) {
                            console.log(res);
                            setState({
